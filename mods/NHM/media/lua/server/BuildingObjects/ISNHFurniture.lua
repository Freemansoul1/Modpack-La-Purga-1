...
ISNHFurniture = ISBuildingObject:derive("ISNHFurniture");

--************************************************************************--
--** ISNHFurniture:new
--**
--************************************************************************--
function ISNHFurniture:create(x, y, z, north, sprite)
...
function ISNHFurniture:removeFromGround(square)
...
function ISNHFurniture:new(name, sprite, northSprite)
	local o = {};
	setmetatable(o, self);
	self.__index = self;
	o:init();
...
function ISNHFurniture:isValid(square)
...
function ISNHFurniture:render(x, y, z, square)
