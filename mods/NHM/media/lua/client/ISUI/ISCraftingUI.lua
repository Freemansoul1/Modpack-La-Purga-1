...
--    y = y + 10;
    ...
    if not selectedItem.evolved and selectedItem.recipe:getNearItem() then
        local nearItem = getText("IGUI_NearItem_"..string.gsub(selectedItem.recipe:getNearItem(),"%s+", ""))
        self:drawText(getText("IGUI_CraftUI_NearItem", nearItem), x, y, 1,1,1,1, UIFont.Medium);
        y = y + ISCraftingUI.mediumFontHeight;
    end
    if not selectedItem.evolved then
