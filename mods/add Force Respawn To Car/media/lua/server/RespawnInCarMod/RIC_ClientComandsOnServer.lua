...
function RICserver.ClientCommand.PrintInfos()
	RICserver.ModDataTest()
	print("") ; print("---------------- RIC PRINT INFO OF PLAYERS LISTED ----------------") ; print("")
	print("INFO: To reset the RIC mod and reset the player list, connect in debug mode, you will have access to the modData reset option in admin tools.") ; print("")
	print("if FALSE or NIL: No respawn | if TRUE: Respawn on floor | if is NUMBER: Respawn in car") ; print("")
	print("Players list:") ; print("")
