...
if getActivatedMods():contains("Authentic Z - Current1") then
...
table.insert(BanditWeapons.Melee.Prepper, "Base.HuntingKnife1")

-- wave 8
BanditWeapons.Melee.Veteran = BanditWeapons.Melee.Veteran or {}
table.insert(BanditWeapons.Melee.Veteran, "Base.HuntingKnife1")
...
table.insert(BanditWeapons.Melee.Reclaimer, "Base.HuntingKnife1")
...
table.insert(BanditWeapons.Melee.DoomRider, "Base.BaseballBat")

-- wave 14
BanditWeapons.Melee.PrivateMilitia = BanditWeapons.Melee.PrivateMilitia or {}
table.insert(BanditWeapons.Melee.PrivateMilitia, "Base.HuntingKnife1")

-- wave 15
BanditWeapons.Melee.DeathLegion = BanditWeapons.Melee.DeathLegion or {}
table.insert(BanditWeapons.Melee.DeathLegion, "Base.HuntingKnife1")

-- wave 16
BanditWeapons.Melee.NewOrder = BanditWeapons.Melee.NewOrder or {}
table.insert(BanditWeapons.Melee.NewOrder, "Base.HuntingKnife1")

--

BanditWeapons.Primary = BanditWeapons.Primary or {}
table.insert(BanditWeapons.Primary, BanditWeapons.MakeHandgun("Base.AssaultRifle21", "Base.Wiz_LugerClip", 20, "M14Shoot", 38))
table.insert(BanditWeapons.Primary, BanditWeapons.MakeHandgun("Base.AssaultRifle1", "Base.Wiz_LugerClip", 30, "M14Shoot", 12))

BanditWeapons.Secondary = BanditWeapons.Secondary or {}
table.insert(BanditWeapons.Secondary, BanditWeapons.MakeHandgun("Base.Pistol1111", "Base.Wiz_LugerClip", 15, "M9Shoot", 30))
table.insert(BanditWeapons.Secondary, BanditWeapons.MakeHandgun("Base.Pistol21", "Base.Wiz_LugerClip", 7, "M1911Shoot", 37))
table.insert(BanditWeapons.Secondary, BanditWeapons.MakeHandgun("Base.Pistol31", "Base.Wiz_LugerClip", 8, "DesertEagleShoot", 40))

if getActivatedMods():contains("Brita1") then
...
if getActivatedMods():contains("firearmmod1") or getActivatedMods():contains("firearmmodRevamp") then
...
if getActivatedMods():contains("VFExpansion11") then
...
if getActivatedMods():contains("Guns931") then
