...
if getActivatedMods():contains("Brita_21") then
...
for i=1, 4 do
    table.insert(BanditClan.DoomRider.Loot, BanditLoot.MakeItem("Base.Money", 66))
end

for i=1, 4  do
    table.insert(BanditClan.DoomRider.Loot, BanditLoot.MakeItem("Base.Necklace_Gold", 69))
end
