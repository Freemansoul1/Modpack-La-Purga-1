...
for i=1, 4 do
    table.insert(BanditClan.Cannibal.Loot, BanditLoot.MakeItem("Base.Money", 66))
end
for i=1, 4  do
    table.insert(BanditClan.Cannibal.Loot, BanditLoot.MakeItem("Base.Necklace_Gold", 69))
end
--[[
