...
BanditClan.Psychopath.health = 6
...
for i=1, 4 do
    table.insert(BanditClan.Psychopath.Loot, BanditLoot.MakeItem("Base.Money", 66))
end

for i=1, 4  do
    table.insert(BanditClan.Psychopath.Loot, BanditLoot.MakeItem("Base.Necklace_Gold", 69))
end
