...
BanditClan.PrivateMilitia.health = 10
...
if getActivatedMods():contains("USMilitaryPack1") then
...
elseif getActivatedMods():contains("Brita_21") then
...
table.insert(BanditClan.PrivateMilitia.Melee, "Base.HuntingKnife1")
...
for i=1, 4  do
    table.insert(BanditClan.PrivateMilitia.Loot, BanditLoot.MakeItem("Base.Necklace_Gold", 69))
end
