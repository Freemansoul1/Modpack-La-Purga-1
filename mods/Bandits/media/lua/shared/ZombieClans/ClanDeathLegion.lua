...
BanditClan.DeathLegion.health = 14
...
if getActivatedMods():contains("Insurgent1") then
...
table.insert(BanditClan.DeathLegion.Melee, "Base.HuntingKnife1")
...
for i=1, 4 do
    table.insert(BanditClan.DeathLegion.Loot, BanditLoot.MakeItem("Base.Money", 66))
end

for i=1, 4  do
    table.insert(BanditClan.DeathLegion.Loot, BanditLoot.MakeItem("Base.Necklace_Gold", 69))
end
