...
function BanditEvents.Get()
    ...
    weaponsSets.baseballPistol = MakeWeapons("Base.BaseballBat", false, 0, 0, "Base.Pistol31", 15, 4)
    weaponsSets.baseballNailsPistol = MakeWeapons("Base.BaseballBatNails", false, 0, 0, "Base.Pistol31", 15, 4)
    weaponsSets.crowbarPistol = MakeWeapons("Base.Crowbar", false, 0, 0, "Base.Pistol31", 15, 4)
    weaponsSets.leadPipePistol = MakeWeapons("Base.LeadPipe", false, 0, 0, "Base.Pistol31", 15, 4)
    weaponsSets.nightstickPistol = MakeWeapons("Base.Nightstick", false, 0, 0, "Base.Pistol1111", 15, 6)
    
    -- fully armed
    weaponsSets.fullNightstick = MakeWeapons("Base.Nightstick", "Base.AssaultRifle21", 20, 4, "Base.Pistol1111", 15, 3)
    weaponsSets.fullMachete = MakeWeapons("Base.HuntingKnife1", "Base.AssaultRifle21", 20, 5, "Base.Pistol1111", 15, 3)
    weaponsSets.fullKnife = MakeWeapons("Base.HuntingKnife1", "Base.AssaultRifle21", 20, 4, "Base.Pistol1111", 15, 4)
    weaponsSets.fullHandaxe = MakeWeapons("Base.HandAxe", "Base.AssaultRifle21", 20, 4, "Base.Pistol1111", 15, 3)
    weaponsSets.fullKnifeMax = MakeWeapons("Base.HuntingKnife1", "Base.AssaultRifle21", 20, 8, "Base.Pistol21", 15, 5)
