...
function JumpI.OnPlayerUpdate(isoPlayer)
    ...
    if isoPlayer:isCurrentState(PlayerFallingState.instance())
      or isoPlayer:isCurrentState(ClimbOverFenceState.instance())
      or isoPlayer:isCurrentState(ClimbThroughWindowState.instance())
      or isoPlayer:isCurrentState(SwipeStatePlayer.instance())
      or isoPlayer:isCurrentState(PlayerHitReactionState.instance())
      or isoPlayer:isCurrentState(PlayerHitReactionPVPState.instance())
      or isoPlayer:isCurrentState(PlayerGetUpState.instance())
      --or isoPlayer:isCurrentState(PlayerSitOnGroundState.instance())--not tested
      or isoPlayer:isCurrentState(PlayerOnGroundState.instance())
      --or isoPlayer:isCurrentState(BumpedState.instance())--not accessible
      or isoPlayer:isCurrentState(PlayerKnockedDown.instance())
      or isoPlayer:isCurrentState(CloseWindowState.instance())
      or isoPlayer:isbFalling() then
