...
if (not getActivatedMods():contains("TrueActionsDancingVHS1") and 
		not getActivatedMods():contains("TrueActionsDancingVHS_test1")) or
		getActivatedMods():contains("TrueActionsDancingVHS_MAG1") or
		getActivatedMods():contains("TrueActionsDancingVHS_MAG_test1") then
	print("INFO: TRUE ACTIONS DANCING. Magazines WILL spawn1")
