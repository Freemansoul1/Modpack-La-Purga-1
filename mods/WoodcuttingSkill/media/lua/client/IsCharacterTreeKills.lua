...
if getActivatedMods():contains("KillCount1")
or getActivatedMods():contains("KillCountRU1")
or getActivatedMods():contains("KillCountFR1")
or getActivatedMods():contains("KillCountES1") then
