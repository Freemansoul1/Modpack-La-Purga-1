...
MinimalDisplayBars.defaultSettingsFileName = "sDayZ DefaultSettings (".. MinimalDisplayBars.MOD_ID ..").lua"
MinimalDisplayBars.configFileName = "sDayZ Config Options (".. MinimalDisplayBars.MOD_ID ..").lua"
