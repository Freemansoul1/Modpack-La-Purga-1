...
MutiesContextMenuIcons.Options["ContextMenu_Smash_window"] =
getExpandedIconPath("SmashWindow.png");
...
function ISWorldObjectContextMenu.createMenu(player, worldobjects, x, y, test)
    ...
    local option = context:getOptionFromName(getText("ContextMenu_Smash_window"));
    if not option then return context end
    option.iconTexture = getTexture(getExpandedIconPath("SmashWindow.png"));
    return context;
end
--]]