...
MutiesContextMenuIcons.Options["ContextMenu_PickupBrokenGlass"] =
getExpandedIconPath("PickupBrokenGlass.png");
...
function ISWorldObjectContextMenu.createMenu(player, worldobjects, x, y, test)
    ...
    local option = context:getOptionFromName(getText("ContextMenu_PickupBrokenGlass"));
    if not option then return context end
    option.iconTexture = getTexture(getExpandedIconPath("PickupBrokenGlass.png"));
    return context;
end
--]]