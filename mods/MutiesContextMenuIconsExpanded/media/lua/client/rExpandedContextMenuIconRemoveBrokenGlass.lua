...
MutiesContextMenuIcons.Options["ContextMenu_RemoveBrokenGlass"] =
getExpandedIconPath("RemoveBrokenGlass.png");
...
function ISWorldObjectContextMenu.createMenu(player, worldobjects, x, y, test)
    ...
    local option = context:getOptionFromName(getText("ContextMenu_RemoveBrokenGlass"));
    if not option then return context end
    option.iconTexture = getTexture(getExpandedIconPath("RemoveBrokenGlass.png"));
    return context;
end
--]]