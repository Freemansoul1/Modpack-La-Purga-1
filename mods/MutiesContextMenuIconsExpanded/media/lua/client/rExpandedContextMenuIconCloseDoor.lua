...
MutiesContextMenuIcons.Options["ContextMenu_Close_door"] =
getExpandedIconPath("CloseDoor.png");
...
function ISWorldObjectContextMenu.createMenu(player, worldobjects, x, y, test)
    ...
    local option = context:getOptionFromName(getText("ContextMenu_Close_door"));
    if not option then return context end
    option.iconTexture = getTexture(getExpandedIconPath("CloseDoor.png"));
    return context;
end
--]]