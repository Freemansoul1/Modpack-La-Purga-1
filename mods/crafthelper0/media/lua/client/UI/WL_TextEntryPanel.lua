...
---@param initialText string optional argument for the initial text. This can be a string or number (it's converted)
---@param numbersOnly boolean optional argument to lock to numbers only
---@param wholeNumbersOnly boolean optional argument to lock to integers not decimals
