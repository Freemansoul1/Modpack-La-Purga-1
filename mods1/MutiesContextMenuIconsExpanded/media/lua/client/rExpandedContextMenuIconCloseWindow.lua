...
MutiesContextMenuIcons.Options["ContextMenu_Close_window"] =
getExpandedIconPath("CloseWindow.png");
...
function ISWorldObjectContextMenu.createMenu(player, worldobjects, x, y, test)
    ...
    local option = context:getOptionFromName(getText("ContextMenu_Close_window"));
    if not option then return context end
    option.iconTexture = getTexture(getExpandedIconPath("CloseWindow.png"));
    return context;
end
--]]