...
MutiesContextMenuIcons.Options["ContextMenu_Barricade"] =
getExpandedIconPath("Barricade.png");
...
function ISWorldObjectContextMenu.createMenu(player, worldobjects, x, y, test)
    ...
    local option = context:getOptionFromName(getText("ContextMenu_Barricade"));
    if not option then return context end
    option.iconTexture = getTexture(getExpandedIconPath("Barricade.png"));
    return context;
end
--]]