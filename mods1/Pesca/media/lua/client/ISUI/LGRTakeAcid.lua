...
LGRTakeAcidMenu.initContextMenu = function(player, context, worldobjects)
	...
	if hclbarrel ~= nil then
		...
		local text1 = " <RGB:1,1,1> " .. getText("ContextMenu_RechargeAcidTT") .. " <LINE>  <LINE> <RGB:1,1,1>" .. getText("ContextMenu_BarrelContains") .. "<SPACE>" .. LGRTakeAcidMenu.getAmountColor(objectData, TankMultiplier) .. tostring(objectData.AcidContent/(25*TankMultiplier)) .. "%" .. " <LINE>";
		local text2 = " <RGB:1,1,1> " .. getText("Tooltip_craft_Needs") .. ": " .. "<SPACE>";
