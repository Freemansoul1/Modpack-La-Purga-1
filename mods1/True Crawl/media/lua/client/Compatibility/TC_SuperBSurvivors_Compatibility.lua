...
CrawlSuperBComp.OnGameStart = function()
	...
	if getActivatedMods():contains("SuperbSurvivors1") or getActivatedMods():contains("SuperbSurvivorsContinued1") then
	...
	elseif not getActivatedMods():contains("SuperbSurvivors1") or getActivatedMods():contains("SuperbSurvivorsContinued1") then
