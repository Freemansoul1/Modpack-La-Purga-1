...
if getActivatedMods():contains("ToolsOfTheTrade1") then
...
if getActivatedMods():contains("PaintableCrowbars1") or getActivatedMods():contains("PaintableCrowbars_SND_HL11") or getActivatedMods():contains("PaintableCrowbars_SND_HL21") then
	zReBLAdjust("Base.Crowbar","Tags","Crowbar;RemoveBarricade;zReBLCrow");
...
if getActivatedMods():contains("MonmouthCounty_new1") then
...
if getActivatedMods():contains("MonmouthCountyTributeLegacy1") then
	zReBLAdjust("MonmouthWeapons.CrowbarScorpion","Tags","Crowbar;RemoveBarricade;zReBLCrow");
end

-- id: BasedCrowaxe
if getActivatedMods():contains("BasedCrowaxe1") then
