...
if getActivatedMods():contains("HNDLBR_Preppers1") then
...
table.insert(BanditClan.Prepper.Melee, "Base.HuntingKnife1")
...
for i=1, 4 do
    table.insert(BanditClan.Prepper.Loot, BanditLoot.MakeItem("Base.Money", 66))
end

for i=1, 4  do
    table.insert(BanditClan.Prepper.Loot, BanditLoot.MakeItem("Base.Necklace_Gold", 69))
end
