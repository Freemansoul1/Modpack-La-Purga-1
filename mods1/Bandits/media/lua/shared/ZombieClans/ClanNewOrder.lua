...
if getActivatedMods():contains("KATTAJ1_Military1") then
...
table.insert(BanditClan.NewOrder.Melee, "Base.HuntingKnife1")
...
for i=1, 4 do
    table.insert(BanditClan.NewOrder.Loot, BanditLoot.MakeItem("Base.Money", 66))
end

for i=1, 4  do
    table.insert(BanditClan.NewOrder.Loot, BanditLoot.MakeItem("Base.Necklace_Gold", 69))
end
