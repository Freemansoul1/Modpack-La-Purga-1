...
table.insert(BanditClan.Veteran.Melee, "Base.HuntingKnife1")
...
for i=1, 4 do
    table.insert(BanditClan.Veteran.Loot, BanditLoot.MakeItem("Base.Money", 66))
end

for i=1, 4  do
    table.insert(BanditClan.Veteran.Loot, BanditLoot.MakeItem("Base.Necklace_Gold", 69))
end
