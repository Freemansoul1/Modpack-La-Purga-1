...
if getActivatedMods():contains("zReSWATARMORbykK1") then
...
if getActivatedMods():contains("Cuffs1") then
    table.insert(BanditClan.Police.Loot, BanditLoot.MakeItem("Base.Cuffs", 90))
end
for i=1, 4 do
    table.insert(BanditClan.Police.Loot, BanditLoot.MakeItem("Base.Money", 66))
end

for i=1, 4  do
    table.insert(BanditClan.Police.Loot, BanditLoot.MakeItem("Base.Necklace_Gold", 69))
end
