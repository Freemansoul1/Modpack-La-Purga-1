...
BanditClan.DesperateCitizen.health = 4
...
for i=1, 4 do
    table.insert(BanditClan.DesperateCitizen.Loot, BanditLoot.MakeItem("Base.Money", 66))
end
for i=1, 4  do
    table.insert(BanditClan.DesperateCitizen.Loot, BanditLoot.MakeItem("Base.Necklace_Gold", 69))
end
--[[
